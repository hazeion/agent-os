...
from deploy.caddy.owner_integration import run_owner_integration
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        if args.run_disposable:
            ...
            run_owner_integration(caddy=args.caddy_bin, certificate=args.test_cert, key=args.test_key, host=args.host)
