...
const preview = { ...envelope, affected: counts, confirmation_id: "a".repeat(64), has_active_runs: true, retained_context_versions: 0, retained_input_versions: 0, retained_deliverable_versions: 0, target_id: "task_alpha", target_kind: "task" as const };
