...
image data URLs, and revisioned/idempotent Kanban. Direct files and artifacts
remain unavailable.
...
Until that contract is advertised and verified, Mentat labels remote Kanban unavailable.
