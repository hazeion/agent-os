...
class DataLayoutContractTests(unittest.TestCase):
    ...
    def test_primary_docs_link_the_contract_and_bound_the_implementation(self):
        ...
        self.assertIn("Milestone 1D schema versioning complete", normalized_roadmap)
        self.assertIn("| 1 | Durable user data | In progress — 1A, 1B, 1C, and 1D complete |", ROADMAP)
