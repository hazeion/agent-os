...
class DataLayoutContractTests(unittest.TestCase):
    def test_canonical_contract_distinguishes_read_only_from_writable_work(self):
        ...
        self.assertIn("Milestone 1C legacy durable-JSON migration implemented", CONTRACT)
    ...
    def test_primary_docs_link_the_contract_and_bound_the_implementation(self):
        ...
        self.assertIn("Milestone 1C legacy durable-JSON migration complete", normalized_roadmap)
        self.assertIn("| 1 | Durable user data | In progress — 1A, 1B, and 1C complete |", ROADMAP)
