...
class PlanningDeletionTests(unittest.TestCase):
    ...
    def test_server_preview_and_confirm_expose_only_counted_effects(self):
        ...
        self.assertEqual(set(preview), {"schema_version", "target_kind", "target_id", "confirmation_id", "affected", "has_active_runs", "retained_context_versions", "retained_input_versions", "retained_deliverable_versions"})
