...
class RemoteSessionTests(unittest.TestCase):
    ...
    def test_remote_search_rejects_path_and_secret_shaped_public_text_end_to_end(self):
        private_values = (
            ...
            ("invisible_actual_key", f"Release {SECRET.replace('NEVER', 'NEVER\u200b')}"),
            ("invisible_actual_session_id", f"Release {UPSTREAM_ID.replace('upstream', 'upstream\u2060')}"),
            ...
            ("mongolian_invisible_key", f"Release {SECRET.replace('NEVER', 'NEVER\u180b')}"),
            ("hangul_filler_id", f"Release {UPSTREAM_ID.replace('upstream', 'upstream\u115f')}"),
            ...
            ("reserved_ignorable_actual_key", f"Release {SECRET.replace('NEVER', 'NEVER\ufff0')}"),
