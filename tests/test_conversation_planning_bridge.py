...
class ConversationPlanningBridgeTests(unittest.TestCase):
    ...
    def test_planning_deletion_is_a_count_only_exact_capability(self):
        preview = {
            ...
            "has_active_runs": True, "retained_context_versions": 0, "retained_input_versions": 0,
        }
        ...
        self.assertEqual(status, 200)
        self.assertEqual(set(payload), {"schema_version", "service", "runtime", "status", "target_kind", "target_id", "confirmation_id", "affected", "has_active_runs", "retained_context_versions", "retained_input_versions"})
