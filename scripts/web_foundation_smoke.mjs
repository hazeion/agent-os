  ...
  const injection = await client.call("Page.addScriptToEvaluateOnNewDocument", { source: `(() => {
    ...
    class MockEventSource extends EventTarget {
      constructor(url) {
        ...
        const events = vercel ? [{ id: 'event_3770d3319d77fb26ae232eba', run_id: 'run_vercel', sequence: 1, type: 'message', occurred_at: '2026-08-22T10:01:05Z', summary: 'Vercel AI Gateway returned a response', message: 'Vercel result <script>window.__vercelMessageExecuted = true</script>', metrics: { total_tokens: 21 }, presentation: null }] : [];
