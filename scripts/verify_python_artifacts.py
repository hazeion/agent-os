...
PUBLIC_MODULES = {
    ...
    "codex_runtime", "codex_task_creation", "planning_deletion", "command_manifest", "conversation_attachments", "conversation_planning", "conversation_repository", "data_backup_restore", "data_layout",
    "data_migration",
