...
PUBLIC_MODULES = {
    ...
    "owner_auth", "owner_auth_setup", "owner_gateway", "owner_auth_google", "owner_auth_google_transport", "owner_auth_google_transactions", "owner_auth_google_worker", "owner_auth_webauthn", "private_console_unit", "private_state", "project_repository", "remote_hermes", "runtime_config",
