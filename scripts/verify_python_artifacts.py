...
PUBLIC_MODULES = {
    ...
    "link_preview_cache", "link_preview_image", "link_preview_metadata", "link_preview_policy",
    ...
    "owner_auth", "owner_auth_setup", "owner_gateway", "owner_auth_google", "owner_auth_google_transport", "owner_auth_google_transactions", "owner_auth_google_worker", "owner_auth_webauthn", "private_console_unit", "private_state", "project_context", "project_context_access", "project_context_editor", "project_context_http", "project_repository", "project_deliverables", "project_deliverables_http", "project_deliverable_review", "project_plans", "project_plans_http", "owner_inbox", "owner_inbox_http", "remote_hermes", "runtime_config",
    "run_attention", "run_input_receipts", "run_repository", "server", "task_delegation_receipts", "task_planning", "task_repository", "task_inputs", "task_inputs_http",
