...
class TaskRepository:
    ...
    def _require_schema(self) -> None:
        ...
        allowed_versions = (
            {5, 6, 7, 8, 10, 11, 12, 13, 14, 15, 16, 24, 25, 26, 27, 28, 29, 30, 31, 32, DATABASE_SCHEMA_VERSION}
            if self.allow_pre_authority_schema
            else {6, 7, 8, 10, 11, 12, 13, 14, 15, 16, 24, 25, 26, 27, 28, 29, 30, 31, 32, DATABASE_SCHEMA_VERSION}
        )
